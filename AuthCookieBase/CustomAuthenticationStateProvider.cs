...
namespace AuthCookieBase
{
    public class CustomAuthenticationStateProvider : AuthenticationStateProvider
    {
        ...
        private AuthenticationState _currentUser;//A readonly field cannot be assigned to (except in a constructor or init-only setter of the type in which the field is defined or a variable initializer)
